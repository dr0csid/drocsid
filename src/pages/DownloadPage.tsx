  ...
  const platforms = [
    {
      ...
      href: 'LINK TO DOWNLOAD FILE/Drocsid-Setup.exe',
      icon: WindowsIcon,
    ...
    },
    {
      ...
      href: 'LINK TO DOWNLOAD FILE/Drocsid-macOS.dmg',
      icon: AppleIcon,
    ...
    },
    {
      ...
      href: 'LINK TO DOWNLOAD FILE/drocsid-linux.zip',
      icon: LinuxIcon,
    ...
    },
    {
      ...
      href: 'LINK TO DOWNLOAD FILE/drocsid-mobile.apk',
      icon: AndroidIcon,
