      ...
      <div className="bg-zinc-800 p-8 rounded-2xl shadow-xl w-full max-w-md text-center">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full bg-white text-zinc-900 font-semibold py-3 px-4 rounded-lg hover:bg-zinc-100 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {loading ? (
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-zinc-700 text-white font-semibold py-3 px-4 rounded-lg hover:bg-zinc-600 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
          >
